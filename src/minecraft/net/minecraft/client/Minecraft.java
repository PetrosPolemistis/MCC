...
import mcheese.hooks.EntityRendererHook;
import mcheese.hooks.GuiIngameHook;
import mcheese.hooks.NetworkManagerHook;
import mcheese.hooks.PlayerControllerMPHook;
...
public class Minecraft implements IPlayerUsage
{
    ...
    //TODO: MCheese
    public PlayerControllerMPHook playerController;
    ...
    //TODO: MCheese
    public mcheese.hooks.EntityClientPlayerMPHook thePlayer;
    ...
    //TODO: MCheese
    public EntityRendererHook entityRenderer;
    ...
    //TODO: MCheese
    public NetworkManagerHook myNetworkManager;
    ...
    private void startGame() throws LWJGLException
    {
        ...
        //TODO: start MCheese Client
        MCheese.theClient.startClient();
    ...
    {
    	//TODO: MCheese
    	GameTickEvent event = new GameTickEvent();
        ...
        if (this.currentScreen == null || this.currentScreen.field_146291_p)
        {
            ...
            while (Keyboard.next())
            {
                ...
                //TODO: MCheese
            	KeyPressEvent e = new KeyPressEvent(Keyboard.getEventKey());
            	MCheese.theClient.getEventManager().callEvent(e);
    ...
    public void launchIntegratedServer(String p_71371_1_, String p_71371_2_, WorldSettings p_71371_3_)
    {
        ...
        NetworkManagerHook var12 = NetworkManagerHook.provideLocalClient(var11);
    ...
    public void setDimensionAndSpawnPlayer(int p_71354_1_)
    {
        ...
        this.renderViewEntity = null;
        this.thePlayer = (EntityClientPlayerMPHook) this.playerController.func_147493_a(this.theWorld, this.thePlayer == null ? new StatFileWriter() : this.thePlayer.func_146107_m());
