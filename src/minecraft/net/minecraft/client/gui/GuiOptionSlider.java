...
public class GuiOptionSlider extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft p_146119_1_, int p_146119_2_, int p_146119_3_)
    {
        if (this.visible)
        {
            ...
            {
                this.field_146134_p = (float)(p_146119_2_ - (this.width + 4)) / (float)(this.x_pos - 8);
            ...
            this.drawTexturedModalRect(this.width + (int)(this.field_146134_p * (float)(this.x_pos - 8)), this.height, 0, 66, 4, 20);
            this.drawTexturedModalRect(this.width + (int)(this.field_146134_p * (float)(this.x_pos - 8)) + 4, this.height, 196, 66, 4, 20);
        }
    }
    ...
    public boolean mousePressed(Minecraft p_146116_1_, int p_146116_2_, int p_146116_3_)
    {
        ...
        {
            this.field_146134_p = (float)(p_146116_2_ - (this.width + 4)) / (float)(this.x_pos - 8);
