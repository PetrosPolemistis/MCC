...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        if (this.field_146344_y)
        {
            ...
            {
                this.fontRendererObj.drawSplitString(I18n.format(WorldType.worldTypes[this.field_146331_K].func_151359_c(), new Object[0]), this.field_146320_D.width + 2, this.field_146320_D.height + 22, this.field_146320_D.getXpos(), 10526880);
            }
        }
        else
        {
